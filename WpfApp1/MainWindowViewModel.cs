...
namespace WpfApp1
{
    public class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        public double Height { get { return height; } 
            set { height = value; Console.WriteLine(height); 
        ...
        public double Square_1 { get { return square_1; } 
            set { square_1 = value; 
        ...
        public double Square_2 { get { return square_2; } 
            set { square_2 = value; OnPropertyChanged(nameof(Square_2)); 
                Result = Class1.VolumeCon(height, square_1, square_2);  
            } 
        }
